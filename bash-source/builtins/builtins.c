...
struct builtin static_shell_builtins[] = {
  ...
  { "mcp", mcp_builtin, BUILTIN_ENABLED | STATIC_BUILTIN, mcp_doc,
     N_("mcp [connect servername | disconnect | list]"), (char *)NULL },
...
char * const mcp_doc[] = {
#if defined (HELP_BUILTIN)
N_("Manage MCP (Managed Control Points) connections.\n\
    \n\

...
struct builtin static_shell_builtins[] = {
  ...
  { "ask", ask_builtin, BUILTIN_ENABLED | STATIC_BUILTIN, ask_doc,
     N_("ask [question...]"), (char *)NULL },
...
char * const ask_doc[] = {
#if defined (HELP_BUILTIN)
N_("Ask the configured model a question; optionally execute returned shell commands.\n\
    \n\
